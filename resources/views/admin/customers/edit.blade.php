    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 mb-4 sm:mb-6 animate-slide-in-down">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="flex items-center space-x-3 sm:space-x-4">
                ...
                <div>
                    <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Edit Customer</h1>
                    <p class="text-xs sm:text-sm text-gray-600">Update customer information</p>
                </div>
            </div>
            <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                ...
                <a href="{{ route('admin.customers.show', $customer) }}" 
                   ...
                   style="background: linear-gradient(135deg, #6366f1 0%, #4f46e5 100%) !important; text-shadow: 0 1px 2px rgba(0,0,0,0.1);">
                    <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                    </svg>
                    <span class="hidden sm:inline">View Customer</span>
            ...
            <div class="p-4 sm:p-6">
                ...
                <div class="mb-6 sm:mb-8">
                    <div class="flex items-center mb-4 sm:mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-xs sm:text-sm text-gray-600">Update customer details</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   readonly>
                            <p class="text-sm text-gray-500 mt-1">Customer ID cannot be changed</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Manage account status and verification</p>
                        </div>
                    </div>
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5 mt-1">
                                <input id="email_verified" 
                                       ...
                                       type="checkbox" 
                                       value="1"
                                       {{ old('email_verified', $customer->email_verified_at ? true : false) ? 'checked' : '' }}
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-sm text-gray-500">
                                    @if($customer->email_verified_at)
                                        Currently verified on {{ $customer->email_verified_at->format('M d, Y') }}
                                    @else
                        ...
                        <div>
                            ...
                            <div class="space-y-2 text-sm">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-gray-900">{{ $customer->orders_count ?? 0 }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mb-8">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900">Password Update</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1">Must match new password</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <div>
                        ...
                        <textarea name="notes" 
                                  ...
                                  placeholder="Add any notes about this customer (optional)">{{ old('notes', $customer->notes ?? '') }}</textarea>
                        @error('notes')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
