            ...
            <div class="max-w-2xl mx-auto">
                ...
                <div class="mt-8 pt-8 border-t border-gray-200">
                    ...
                    <div id="variations-container" class="space-y-4">
                        ...
                        <div class="variation-item bg-white border-2 border-gray-200 rounded-lg p-6 relative" data-variation="{{ $index }}">
                            <button type="button" 
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select name="variations[{{ $index }}][type]" 
                                        ...
                                        <option value="Length" {{ $variation->type == 'Length' ? 'selected' : '' }}>Length</option>
                                        <option value="Wattage" {{ $variation->type == 'Wattage' ? 'selected' : '' }}>Wattage</option>
                                        <option value="Voltage" {{ $variation->type == 'Voltage' ? 'selected' : '' }}>Voltage</option>
                                        <option value="Capacity" {{ $variation->type == 'Capacity' ? 'selected' : '' }}>Capacity</option>
                                        <option value="Weight" {{ $variation->type == 'Weight' ? 'selected' : '' }}>Weight</option>
                                        ...
                                        <option value="Other" {{ $variation->type == 'Other' ? 'selected' : '' }}>Other</option>
                                    </select>
                                </div>
                                ...
                                <div class="flex items-center pt-8">
                                    ...
                                    <label for="variation_active_{{ $index }}" class="ml-2 text-sm font-medium text-gray-700">
                                        Active
                                    </label>
                                </div>
                            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="flex items-center pt-8">
                    <input type="checkbox"
                           ...
                           class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                    <label for="variation_active_${variationCount}" class="ml-2 text-sm font-medium text-gray-700">Active</label>
                </div>
            </div>
        </div>
    `;
