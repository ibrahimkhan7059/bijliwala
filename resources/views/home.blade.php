...
@section('title', 'Home - Electrical & Solar Products')
...
<div class="py-4 md:py-8" style="background: linear-gradient(180deg, rgba(255,245,230,0.5) 0%, rgba(255,237,213,0.8) 50%, rgba(255,228,196,0.5) 100%);">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Hero Section -->
        <div class="relative bg-gradient-to-br from-amber-500 via-orange-500 to-red-500 rounded-2xl md:rounded-3xl shadow-2xl overflow-hidden mb-8 md:mb-12">
            <!-- Decorative Elements -->
            ...
            <div class="relative px-4 py-8 md:p-12 lg:p-16 text-white text-center">
                <div class="max-w-4xl mx-auto">
                    <h1 class="text-3xl md:text-5xl lg:text-6xl font-extrabold mb-3 md:mb-4 leading-tight">
                        Welcome to <br class="md:hidden"/>Bijli Wala Bhai
                    </h1>
        ...
        <div class="mb-8 md:mb-12 bg-gradient-to-br from-orange-100/80 via-amber-50/90 to-yellow-100/80 backdrop-blur-sm rounded-3xl p-6 md:p-8 shadow-xl border-2 border-orange-200">
        ...
        <div class="mb-8 md:mb-12 bg-gradient-to-br from-orange-100/90 via-amber-100/90 to-yellow-100/90 backdrop-blur-sm rounded-3xl p-6 md:p-8 shadow-xl border-2 border-orange-200">
        ...
        <div class="mb-8 md:mb-12 bg-gradient-to-br from-blue-100/90 via-sky-100/90 to-cyan-100/90 backdrop-blur-sm rounded-3xl p-6 md:p-8 shadow-xl border-2 border-blue-200">
            <div class="flex justify-between items-center mb-4 md:mb-6">
                <div class="flex items-center space-x-2">
                    <span class="text-2xl">✨</span>
                    <h2 class="text-2xl md:text-3xl font-bold text-gray-900">New & Latest</h2>
                </div>
                <a href="{{ route('shop') }}" class="text-sm md:text-base text-indigo-600 hover:text-indigo-800 font-semibold flex items-center group">
                    <span>View All</span>
                    <svg class="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6">
                ...
                <div class="bg-gradient-to-br from-sky-50 via-blue-50 to-cyan-50 rounded-xl shadow-lg overflow-hidden card-hover group relative border-2 border-blue-200">
                    <div class="absolute top-2 right-2 z-10 bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-2 md:px-3 py-1 rounded-full text-xs font-bold shadow-lg">
                        NEW
                    </div>
                    <a href="{{ route('product.show', $product->slug) }}" 
                       class="block aspect-square overflow-hidden bg-gray-100 relative"
                    ...
                    <div class="p-3 md:p-4">
                        ...
                        @if($product->stock_quantity > 0)
                            <form action="{{ route('cart.add') }}" method="POST">
                                ...
                                <input type="hidden" name="product_id" value="{{ $product->id }}">
                                <input type="hidden" name="quantity" value="1">
                                <button type="submit" class="w-full btn-success py-2 px-3 rounded-lg text-xs md:text-sm font-semibold flex items-center justify-center space-x-1">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                                    </svg>
                                    <span>Add to Cart</span>
        ...
        <!-- Contact Info -->
        <div class="bg-gradient-to-br from-gray-900 via-gray-800 to-orange-900 rounded-2xl md:rounded-3xl p-6 md:p-10 text-white shadow-2xl">
            <div class="text-center mb-6 md:mb-8">
                <h3 class="text-2xl md:text-3xl font-bold mb-2">Get in Touch</h3>
