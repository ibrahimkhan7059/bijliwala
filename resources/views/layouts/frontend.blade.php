            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li class="flex items-start text-sm">
                            <svg class="w-5 h-5 mr-3 text-green-400 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                ...
                                <a href="https://wa.me/{{ $siteSettings->site_whatsapp }}" target="_blank" rel="noopener noreferrer" class="text-white font-semibold hover:text-green-400 transition-colors">
