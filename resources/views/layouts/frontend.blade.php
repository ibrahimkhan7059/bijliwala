...
<head>
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-HYJQ4B5KTK"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'G-HYJQ4B5KTK');
    </script>
...
<body class="font-sans antialiased smooth-scroll" style="background: linear-gradient(135deg, #fff5e6 0%, #ffe4c4 25%, #ffd7a8 50%, #ffedd5 75%, #fff5e6 100%); background-attachment: fixed;" x-data="{ mobileMenuOpen: false }">
            ...
            <div class="flex items-center h-16 md:h-20">
                ...
                <div class="flex items-center flex-shrink-0">
                    ...
                    <a href="{{ route('home') }}" class="flex items-center space-x-2">
                        <img src="{{ $siteSettings->site_logo ? asset('storage/' . $siteSettings->site_logo) . '?v=' . time() : asset('images/logo.avif') }}" alt="{{ $siteSettings->site_name }} Logo" class="h-10 w-10 md:h-12 md:w-12 object-contain max-w-full">
                    ...
                    <div class="mb-6">
                        ...
                        <ul class="space-y-2">
                            ...
                            <li class="flex items-start text-sm">
                                <svg class="w-4 h-4 mr-2 text-green-400 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <div>
                                    <p class="text-gray-300">
                                        <a href="https://wa.me/{{ preg_replace('/[^\d]/', '', $siteSettings->solar_contact_whatsapp) }}" 
                                           class="hover:text-green-300 transition-colors">
                                            WhatsApp: {{ $siteSettings->solar_contact_whatsapp }}
                                        </a>
                                    </p>
                                </div>
                            </li>
                            @endif
                            @if(isset($siteSettings->solar_contact_email) && $siteSettings->solar_contact_email)
                            <li class="flex items-start text-sm">
                                ...
                                <div>
                                    <p class="text-gray-300">
                                        <a href="mailto:{{ $siteSettings->solar_contact_email }}" 
                                           class="hover:text-blue-300 transition-colors">
                                            Email: {{ $siteSettings->solar_contact_email }}
                                        </a>
                                    </p>
                                </div>
                            </li>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2">
                            ...
                            <li class="flex items-start text-sm">
                                ...
                                <div>
                                    <p class="text-gray-300">
                                        <a href="https://wa.me/{{ preg_replace('/[^\d]/', '', $siteSettings->orders_contact_whatsapp) }}" 
                                           class="hover:text-green-300 transition-colors">
                                            WhatsApp: {{ $siteSettings->orders_contact_whatsapp }}
                                        </a>
                                    </p>
                                </div>
                            </li>
                            @endif
                            @if(isset($siteSettings->orders_contact_email) && $siteSettings->orders_contact_email)
                            <li class="flex items-start text-sm">
                                <svg class="w-4 h-4 mr-2 text-blue-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
                                <div>
                                    <p class="text-gray-300">
                                        <a href="mailto:{{ $siteSettings->orders_contact_email }}" 
                                           class="hover:text-blue-300 transition-colors">
                                            Email: {{ $siteSettings->orders_contact_email }}
                                        </a>
                                    </p>
                                </div>
                            </li>
                            @endif
                            @if(isset($siteSettings->business_location) && $siteSettings->business_location)
                            <li class="flex items-start text-sm">
                                <svg class="w-4 h-4 mr-2 text-yellow-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                                </svg>
                                <div>
                                    <p class="text-gray-300">Location: {{ $siteSettings->business_location }}</p>
                                </div>
                            </li>
                            @endif
                        </ul>
    ...
    <script>
        // Simple helpers for mobile sidebar - pure JS so it always works
